...
// Fetch active layout setting (defaults to 1 if table doesn't exist or fails)
...
// Listen for live layout changes in Supabase
function subscribeToLayoutChange(onUpdate) {
    try {
